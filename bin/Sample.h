...
public:
	...
	void randomSelectSample(int*sampleIndex,int*testIndex,int SampleNum,int selectedSampleNum);
	...
	inline int*getTestIndex() { return _testIndex; };
	inline int getTestNum() { return _testNum; };
